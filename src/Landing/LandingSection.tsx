...
function LandingSection({ref, onAboutClick, onProjectClick}: HeroSectionProps) {
    return (
        <section id={"landing"} ref={ref} className="min-h-screen flex items-center snap-start relative overflow-hidden">
