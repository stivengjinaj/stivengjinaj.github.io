...
function AcademicCard(){
    return (
        <div className="flex w-full flex-col backdrop-blur-xs bg-zinc-50/10 dark:bg-zinc-900/30 border border-gray-200 dark:border-zinc-800 shadow-xl rounded-xl px-6 md:px-10 lg:px-20 py-8">
