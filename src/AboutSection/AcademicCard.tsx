...
function AcademicCard(){
    return (
        <div className="flex w-full flex-col opacity-90 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow-xl rounded-xl px-6 md:px-10 lg:px-20 py-8">
