...
function Publications ({title, conference, link}: PublicationProp) {
    return (
        <div className="flex items-center gap-4 rounded-xl backdrop-blur-sm bg-zinc-100/80 dark:bg-transparent dark:border dark:border-zinc-700 p-3">
            <div className="hidden md:flex bg-zinc-200 dark:bg-transparent dark:border dark:border-zinc-700 rounded-xl p-6">
                <NewspaperIcon className="dark:text-gray-300"/>
            </div>
            <div className="flex-col md:flex flex-1 items-end justify-items-end">
                <div>
                ...
                <button
                    className="flex mt-1 md:mt-0 items-center gap-1 rounded-xl border border-zinc-500 hover:bg-zinc-200 dark:hover:bg-zinc-800 px-3 py-2"
