...
function Publications () {
    return (
        <div className="flex flex-col gap-4 backdrop-blur-xs bg-zinc-50/10 dark:bg-zinc-900/30 border border-gray-200 dark:border-zinc-800 shadow-lg rounded-xl p-5">
